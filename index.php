...
<!--         <div class="small-12 medium-6 large-6 xlarge columns workprof"  data-wow-delay="0.3s">
              <a href="<?php echo get_permalink($post->ID); ?>">
                <div class="workhover ">
                  <div class="describe">
                    <p class="lookfor"><?php echo the_title(); ?></p>
                    <br>
                    <p class="clientprof">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis enim at quam iaculis ultricies. Integer eget interdum mi, et tincidunt metus. Duis eget urna elementum lectus pellentesque rutrum et in urna.</p>
                  </div>
                </div>
                    <?php
                      $src = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), array( 5600,1000 ), false, '' );
